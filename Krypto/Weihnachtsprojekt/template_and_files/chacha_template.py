...
"""
Helper functions to conveniently print and plot data. These functions do not need to be changed.
"""
...
if __name__ == '__main__':
	...
	process_file(source_file='encrypted.zip', target_file='decrypted.zip') # decrypt
